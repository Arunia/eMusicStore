...
<div class="container-wrapper">
    <div class="container">
        ...
        <!-- without this line when editing a product a new one will be created => reasign the id value-->
        <form:hidden path="productId" value="${product.productId}" />

        <div class="form-group">
            <label for="name">Name</label><form:errors path="productName" cssStyle="color:darkred;" />
        ...
        <div class="form-group">
            <label for="price">Price</label><form:errors path="productPrice" cssStyle="color: darkred;" />
